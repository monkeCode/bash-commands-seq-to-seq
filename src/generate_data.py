...
def generate_descriptions(input_csv, output_csv, base_urls, command_column='command', 
                         max_workers=5, limit=None, timeout=120):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--base_urls', type=str, required=True, 
