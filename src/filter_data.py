...
r = pd.concat([df1, big_frame[["command", "description"]], internet_frame[["command", "description"]], yet_another_commands[["command", "description"]]]).drop_duplicates(["description","command"])
